...
if [[ ! -f "$TARGET_GTSAM_LIB" ]]; then
    ...
    GTSAM_OPTIONS="-DGTSAM_USE_SYSTEM_METIS=ON -DGTSAM_ENABLE_BOOST_SERIALIZATION=OFF -DGTSAM_USE_SYSTEM_EIGEN=ON -DGTSAM_BUILD_WITH_MARCH_NATIVE=OFF -DGTSAM_BUILD_PYTHON=ON -DGTSAM_BUILD_TESTS=OFF -DGTSAM_BUILD_EXAMPLES=OFF"
